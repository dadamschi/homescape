...
type BlogListItem = Pick<BlogPost, "_id" | "title" | "slug" | "publishedAt" | "excerpt" | "category">;
    ...
    <main style={{
      ...
      <section style={{
        ...
        <p style={{
          ...
          Expert advice on Chicago construction trends, seasonal tips, and home
          improvement ideas from the Homescape team.
        </p>
      </section>
